buildscript {
    ...
    dependencies {
        classpath("io.github.nchaugen:tabletest-reporter-gradle-plugin:0.2.2-SNAPSHOT")
    }
}
...
dependencies {
    ...
    testImplementation("io.github.nchaugen:tabletest-reporter-junit:0.2.2-SNAPSHOT")
}
