> [!IMPORTANT]
> TableTest Reporter has new Maven coordinates: `org.tabletest:tabletest-reporter-*:1.2.0`
>
...
```kotlin
plugins {
  id("org.tabletest.reporter") version "1.2.0"
}
```
...
Gradle:
```kotlin
testImplementation("org.tabletest:tabletest-reporter-junit:1.2.0")
```
