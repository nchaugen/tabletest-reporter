> [!IMPORTANT]
> TableTest Reporter has new Maven coordinates: `org.tabletest:tabletest-reporter-*:1.3.0`
>
...
```kotlin
plugins {
  id("org.tabletest.reporter") version "1.3.0"
}
```
...
Gradle:
```kotlin
testImplementation("org.tabletest:tabletest-reporter-junit:1.3.0")
```
